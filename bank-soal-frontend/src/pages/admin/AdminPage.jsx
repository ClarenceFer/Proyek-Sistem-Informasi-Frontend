...
const API_URL = 'https://hosting-backend-prosi.up.railway.app/api/admin/';  // Pastikan port dan path ini benar
      ...
      <div className="w-full mx-auto px-8 lg:px-12 xl:px-16 py-5">
        <div className="flex items-center justify-between gap-8">
          ...
          <nav className="flex justify-center items-center space-x-6 lg:space-x-8 flex-1">
            <Link to="/admin/dosen" className="text-blue-600 font-semibold relative px-3 py-2 transition-colors hover:text-blue-700">
              Dosen
